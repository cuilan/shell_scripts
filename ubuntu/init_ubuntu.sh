...
SOURCES_LIST_URL='http://gitlab.weattech.com//source/-/raw/master/ubuntu_sources.list'
DOCKER_LIST_URL='http://gitlab.weattech.com//source/-/raw/master/docker.list'
OZ_DOWNLOAD_URL='https://github.com/robbyrussell/oh-my-zsh.git'
OZ_CONFIG_DOWNLOAD_URL='http://gitlab.weattech.com//source/-/raw/master/ubuntu-zshrc'
OZ_SYNTAX_HIGHLIGHTING_DOWNLOAD_URL='https://github.com/zsh-users/zsh-syntax-highlighting.git'
VIM_CONFIG_DOWNLOAD_URL='http://gitlab.weattech.com//source/-/raw/master/vimrc'
VIM_PLUGINS_DOWNLOAD_URL='http://gitlab.weattech.com//source/-/raw/master/vim.plugins'
DOCKER_CONFIG_DOWNLOAD_URL='http://gitlab.weattech.com//source/-/raw/master/docker.service'
